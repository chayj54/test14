...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : '_include/img/slider-images/image01.jpg', title : '<div class="slide-content">stop and start</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image02.jpg', title : '<div class="slide-content">All new matching recipe</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image03.jpg', title : '<div class="slide-content">sympathize with your lack</div>', thumb : '', url : ''},
											{image : '_include/img/slider-images/image04.jpg', title : '<div class="slide-content">show your recipe</div>', thumb : '', url : ''}  
									],
...
CHAKRA.contactForm = function(){
	$("#contact-submit").on('click',function() {
		...
		if (confirm("이메일을 전송 하시겠습니까?")) {
			$.ajax({
				type: "POST",
				url: "http://www.recipemonster.co.kr/ap/email/send",
				data: fields,
				dataType : 'json',
...
CHAKRA.map = function(){
	if($('.map').length > 0)
	{
		...
		$('.map').each(function(i,e){
			...
			var contentString = '<img src="_include/img/logo.jpg">';
